...
<div class="portlet box portlet-btcl">
	<div class="portlet-title">
		...
		<%
			...
			out.println("<input type='text' class='form-control' onKeyUp='allfield_changed(\"\",0)' id='anyfield'  name='"+  LM.getText(LC.APPROVAL_TEST_SEARCH_ANYFIELD, loginDTO) +"' ");
			...
			<div class="row col-lg-offset-1">
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-5" style="margin-top: 5px;">
					<div class="col-xs-2 col-sm-4 col-md-4">
						<label for="" class="control-label pull-right"><%=LM.getText(LC.APPROVAL_TEST_SEARCH_DESCRIPTION, loginDTO)%></label>
					</div>
					<div class="col-xs-10 col-sm-8 col-md-8">
						<input type="text" class="form-control" id="description" placeholder="" name="description" onChange='setSearchChanged()'>
					</div>
				</div>
