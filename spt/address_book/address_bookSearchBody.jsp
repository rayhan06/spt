...
<%
String url = "Address_bookServlet?actionType=search";
String navigator = SessionConstants.NAV_ADDRESS_BOOK;
...
%>
	<jsp:include page="./address_bookNav.jsp" flush="true">
		<jsp:param name="url" value="<%=url%>" />
		<jsp:param name="navigator" value="<%=navigator%>" />
		<jsp:param name="pageName" value="<%=LM.getText(LC.ADDRESS_BOOK_SEARCH_ADDRESS_BOOK_SEARCH_FORMNAME, loginDTO)%>" />
	</jsp:include>


<div class="portlet box">
	<div class="portlet-body">
		<form action="Address_bookServlet?isPermanentTable=<%=isPermanentTable%>&actionType=delete" method="POST" id="tableForm" enctype = "multipart/form-data">
			<jsp:include page="address_bookSearchForm.jsp" flush="true">
				<jsp:param name="pageName" value="<%=LM.getText(LC.ADDRESS_BOOK_SEARCH_ADDRESS_BOOK_SEARCH_FORMNAME, loginDTO)%>" />
			</jsp:include>	
		</form>
	</div>
