...
%>
	<jsp:include page="./appointmentNav.jsp" flush="true">
		...
		<jsp:param name="pageName" value="<%=LM.getText(LC.APPOINTMENT_SEARCH_APPOINTMENT_SEARCH_FORMNAME, loginDTO)%>" />
	</jsp:include>


<div class="portlet box">
	<div class="portlet-body">
		<form action="AppointmentServlet?isPermanentTable=<%=isPermanentTable%>&actionType=delete" method="POST" id="tableForm" enctype = "multipart/form-data">
